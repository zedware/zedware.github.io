...
做数据库产品有很多种可能的做法。不管是完全重头开始，还是站在巨人的肩膀上演化都是
...
容/类似 Oracle 的原因，但确实用过其中的 COBASE 数据库，也阅读和修改过其中的一些
...
Oracle 兼容的目标不是一个固定靶，而是一个移动靶。以 Oracle 12 为例，它的功能
...
INFORMATION\_SCHEMA 等，还是用每个产品自己的？
